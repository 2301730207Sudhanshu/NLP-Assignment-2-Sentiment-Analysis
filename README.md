...
This project implements a Sentiment Analysis Model using Natural Language Processing (NLP) and Machine Learning (ML) techniques.
The goal is to classify text as Positive or Negative using a real, large dataset to ensure high accuracy.
...
└── dataset/ (Not required — dataset is loaded from NLTK)
...
https://colab.research.google.com/drive/1oIEdHi92gzN8UKnn1QzHjEvglJYq04fi?authuser=1#scrollTo=teNrYE8FBLJf
